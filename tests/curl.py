...
class CurlManager:
    ...
    def create_curl_script(self) -> bool:
        ...
        try:
            ...
            # Add execute_url function for consistent URL handling and collect all output
...
''')
    ...
    def close_curl_file(self):
        ...
        if self.curl_file:
            try:
                # Close JSON object - sed will remove the trailing comma from last entry and add closing brace
                self.curl_file.write('\n# Close JSON object (remove trailing comma and add closing brace)\n')
                self.curl_file.write(') | sed \'$s/,$/}/\'\n')
    ...
    def load_json_responses_file(self, filename: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Remove trailing comma before closing bracket to fix JSON
