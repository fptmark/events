...
class TestDataCreator:
    ...
    async def create_test_user(self, scenario: str, account_id: str) -> str:
        ...
        if scenario == "valid_all":
            ...
            user_doc["dob"] = "1985-06-15"  # Valid date
            # Missing password and accountId to generate expected warnings
            del user_doc["password"]  # Remove to trigger "Field required" warning
            # Don't set accountId to trigger "Field required" warning
