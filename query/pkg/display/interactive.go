...
// WaitForContinue prompts user and waits for space bar or quit command
func (d *InteractiveDisplay) WaitForContinue() bool {
	fmt.Print("\nPress SPACE to continue, 'q' to quit, 'h' for help: ")

	// Try to read a single character without Enter
	char, err := d.readSingleChar()
	if err != nil {
