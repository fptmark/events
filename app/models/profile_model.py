...
class Profile(Document):
    ...
    __ui_metadata__: ClassVar[Dict[str, Any]] = {'entity': 'Profile', 'ui': {'title': 'Profile', 'buttonLabel': 'Manage User Profiles', 'description': 'Manage User Preferences'}, 'operations': '', 'fields': {'name': {'type': 'String', 'required': True, 'maxLength': 100}, 'preferences': {'type': 'JSON', 'required': False, 'ui': {'displayPages': 'details'}}, 'radiusMiles': {'type': 'Integer', 'required': False, 'min': 0}, 'createdAt': {'type': 'ISODate', 'required': True, 'autoGenerate': True, 'ui': {'readOnly': True, 'displayAfterField': '-1'}}, 'updatedAt': {'type': 'ISODate', 'required': True, 'autoUpdate': True, 'ui': {'displayAfterField': '-2'}}, 'userId': {'type': 'ObjectId', 'required': True, 'displayName': 'User ID', 'readOnly': True}}}
