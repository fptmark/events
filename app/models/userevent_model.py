...
class UserEvent(Document):
    ...
    __ui_metadata__: ClassVar[Dict[str, Any]] = {'entity': 'UserEvent', 'labels': {'title': 'User Events', 'buttonLabel': 'Manage Event Attendance'}, 'operations': '', 'fields': {'attended': {'type': 'Boolean', 'required': False, 'displayName': 'Attended'}, 'rating': {'type': 'Integer', 'required': False, 'min': 1, 'max': 5, 'displayName': 'Rating'}, 'note': {'type': 'String', 'displayPages': 'details', 'required': False, 'maxLength': 500, 'displayName': 'Note'}, 'createdAt': {'type': 'ISODate', 'readOnly': True, 'displayAfterField': '-1', 'required': True, 'autoGenerate': True, 'displayName': 'Created At'}, 'updatedAt': {'type': 'ISODate', 'required': True, 'autoUpdate': True, 'displayAfterField': '-2', 'displayName': 'Updated At'}, 'userId': {'type': 'ObjectId', 'required': True, 'displayName': 'User ID', 'readOnly': True}, 'eventId': {'type': 'ObjectId', 'required': True, 'displayName': 'Event ID', 'readOnly': True}}}
