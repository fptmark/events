...
class Event(BaseModel):
    ...
    async def get_all(cls) -> Dict[str, Any]:
        try:
            ...
            event_data = process_raw_results(cls, "Event", raw_docs, warnings)
    ...
    async def get_list(cls, list_params) -> Dict[str, Any]:
        ...
        try:
            ...
            raw_docs, warnings, total_count = await DatabaseFactory.get_list("event", unique_constraints, list_params)
