...
class Event(BaseModel):
    ...
    async def get_all(cls,
        ...
        for data in data_records:
            ...
            if validation:
                await utils.validate_fks("Event", data, cls._metadata)
            ...
            if view_spec:
                    await utils.populate_view(data, view_spec, "Event")
    ...
    async def get(cls, id: str, view_spec: Optional[Dict[str, Any]]) -> Tuple[Dict[str, Any], int]:
        ...
        data, record_count = await DatabaseFactory.get_by_id(str(id), "Event")
        if data:
