...
class EntityModelProtocol(Protocol):
    ...
    @classmethod
    async def get_all(cls, sort: List[tuple], filter: Dict[str, Any] | None, page: int, pageSize: int, view_spec: Dict[str, Any] | None) -> Dict[str, Any]: ...
    
    @classmethod
    async def get(cls, entity_id: str, view_spec: Dict[str, Any] | None) -> Dict[str, Any]: ...
    
    async def save(self, entity_id: str = '') -> tuple: ...
    
    @classmethod
    async def delete(cls, entity_id: str) -> bool: ...
